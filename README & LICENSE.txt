...
The art assets in this pack (all .dds, .ksp, .png and .mu files) are distributed under ARR license. You may not redistribute or re-use these assets without express permission from the author.
